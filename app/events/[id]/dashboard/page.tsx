...
=======
  Megaphone, 
    Send,
>>>>>>> 34701526fa371bfe6c3ba2eb82f6590086be9b91
  Edit, 
  Swords, 
  ClipboardList, 
  Users, 
...
<<<<<<< HEAD
import Announcements from './Announcements' // Using your Announcements component
import InviteCopy from './InviteCopy'       // Using the new Invite Button
...
export default async function EventDashboard({ params }: { params: Promise<{ id: string }> }) {
  ...
  // 1. Fetch Event Details (Include invite_code)
  ...
  return (
    <main className="min-h-screen bg-club-cream text-club-navy pb-20">
        ...
        <div className="relative z-10">
            ...
            <div className="flex items-center gap-3">
                ...
                {isOrganizer && event?.invite_code && (
                    <InviteCopy code={event.invite_code} />
                )}
            </div>
        </div>
      ...
      <div className="p-6 space-y-6 -mt-4 relative z-20">
        ...
        {/* 2. ANNOUNCEMENTS */}
<<<<<<< HEAD
        <Announcements eventId={id} isOrganizer={isOrganizer} />
=======
        <div>
